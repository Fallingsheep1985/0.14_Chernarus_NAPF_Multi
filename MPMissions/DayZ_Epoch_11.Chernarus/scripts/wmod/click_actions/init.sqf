...
if(isNil "DZE_CLICK_ACTIONS_BUILD") then {
    ...
    call compile preprocessFileLineNumbers "scripts\wmod\click_actions\config.sqf";
   player_selectSlot = compile preprocessFileLineNumbers "scripts\wmod\click_actions\ui_selectSlot.sqf";
